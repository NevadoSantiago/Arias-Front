...
const NAV_ITEMS: NavItem[] = [
  { to: '/company-admin/today',     label: 'Inicio',          icon: Home },
  { to: '/company-admin/employees', label: 'Empleados',       icon: Users },
  { to: '/company-admin/metrics',   label: 'Métricas',        icon: BarChart3 },
];
    ...
    <div className="min-h-full flex flex-col bg-background">
      ...
      <header className="border-b border-border bg-card">
        <div className="flex items-center justify-between h-16 px-6">
          <Link to="/company-admin/today" className="flex items-baseline gap-3">
