...
/**
 * Contenido corporativo (B2B) — trasladado tal cual desde la landing raíz
 * (que ahora es el recorrido B2C) a su propia ruta `/corporate`. Ver diseño
 * F4 en `openspec/changes/b2c-credits-pivot/design.md`: traslado de árbol,
 * no rediseño. Reutiliza `LandingNav`, `QuoteForm` y `useScrollReveal` (vía
 * `Reveal`) sin cambios.
 */
