...
/**
 * Pantalla de pedido del día para empleados de empresa (B2B) — el flujo
 * histórico de un único plato por día contra `/api/v1/orders`, SIN CAMBIOS
 * de comportamiento, texto ni layout. `TodayOrderPage` decide si renderiza
 * esta pantalla o `B2cOrderPage` según `user.companyId`.
 */
export function CompanyOrderPage() {
